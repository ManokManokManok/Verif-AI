...
function Signup() {
  ...
  return (
    <div className="auth auth--signup auth--mobile ">
      {/* Theme Toggle Button */}
      <button 
      ...
      <div className="auth__panel auth__panel--right">
        ...
        {registered ? (
          <div className="auth__success-screen">
            <div className="verify-icon verify-icon--success">✓</div>
            <h1 className="auth__title auth__title--success">Check Your Email</h1>
            <p className="auth__subtitle auth__subtitle--success">
              We&apos;ve sent a verification link to <strong>{email}</strong>.
              <br />
              Please click the link in your email to verify your account before logging in.
            </p>
            <button
              className="auth__submit auth__submit--success"
              onClick={() => navigate('/login')}
            >
              <span>Go to Login</span>
              <span className="auth__submit-arrow">→</span>
            </button>
            <p className="auth__subtitle auth__subtitle--hint">
            ...
            >
              ...
              <div className="auth__error-body">
                {hasMultipleErrors ? (
                  ...
                  <p className="auth__error-text">{errorList[0] || error}</p>
                )}
              </div>
              <button
                type="button"
