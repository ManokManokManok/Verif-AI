...
urlpatterns = [
    ...
    path('password-change/send-code/', views.send_password_change_code, name='send_password_change_code'),
    ...
    path('verify-email/send-code/', views.send_email_verification_code, name='send_email_verification_code'),
    path('verify-email/verify-code/', views.verify_email_code, name='verify_email_code'),
